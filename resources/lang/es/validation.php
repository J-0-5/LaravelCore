...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'student' => 'Estudiante',
        'group_name' => 'Nombre',
        'group_faculty' => 'Facultad',
        'group_parent' => 'Grupo de investigación',
        'group_program' => 'Programa',
        'name_lab' => 'Nombre del laboratorio',
        'building_id' => 'Bloque',
        'floor_lab' => 'Piso',
        'room_name' => 'Salón',
        'faculty' => 'Facultad',
        'program_main' => 'Programa pricipal',
        'group_main' => 'Grupo principal',
        'leader' => 'Docente lider',
        'area' => 'Area',
        'manager_lab' => 'Responsable',
        'document' => 'documento',
        'associate' => 'asociado',
        'id' => 'identificación',
        'proposal_group_id' => 'id grupo de propuesta',
        'opened_date' => 'fecha de apertura',
        'closed_date' => 'fecha de cierre',
        'proposal_type' => 'tipo de proyecto',
        'product_title' => 'titulo',
        'product_code' => 'código de producto',
        'presentation' => 'ponencia',
        'country' => 'país',
        'date' => 'fecha',
        'certificate' => 'aval de creación',
        'final_date' => 'fecha final',
        'account_number' => 'numero de la cuenta',
        'supervisor_id' => 'supervisor',
        'petitioner_id' => 'solicitante',
        'user_document_type' => 'tipo de documento',
        'contract_type' => 'tipo de contrato',
        'dependency' => 'dependencia',
        'execution_time' => 'plazo de ejecución',
        'execution_place' => 'lugar de ejecución',
        'payment_type' => 'forma de pago',
        'training_profile' => 'perfil de formación',
        'technical specifications' => 'especificaciones técnicas',
        'experience' => 'experiencia',
        'closing_date' => 'fecha de solicitud',
        'requirement_description' => 'descripción de la necesidad',
        'contract_purpose' => 'objeto de la contratación',
        'general_obligations' => 'obligaciones generales',
        'specific_obligations' => 'obligaciones especificas',
        'financing source' => 'fuente de financiación',
        'strategic' => 'linea estrategica',
        ...
        'cdp_number' => 'numero CDP',
        'person_type' => 'tipo de persona',
        'supplier_id' => 'buscar contratista',
        'modality' => 'movilidad',
        'insurance_company' => 'aseguradora',
        'insurance_company_nit' => 'nit aseguradora',
        'contract_start_date' => 'fecha de inicio',
        'contract_final_date' => 'fecha fin',
        'contract_value' => 'valor del contrato',
        'warranty_policy' => 'poliza de garantia',
        'contractor_obligations' => 'obligaciones contractuales',
        'observations' => 'obligaciones',
        'bank_id' => 'banco',
