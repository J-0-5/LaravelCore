export default class Parameters {
    ...
    async renderParameterTable(id){
        ...
        [].forEach.call(data, key => {
            ...
            editBtn.innerHTML = '<i class="fas fa-edit" data-tooltip title="Editar"></i>';
            ...
            deleteBtn.innerHTML = '<i class="fas fa-trash-alt" data-tooltip title="Eliminar"></i>';
    ...
    storeParameterValue(){
        ...
        btnStore.addEventListener('click', async () => {
            ...
            let param = document.getElementById("divCreateParameter");
            let param_id = param.dataset.paramDocument;
            ...
            if(this.id){
                ...
                formData.append('parameter_id', param_id);
            }
